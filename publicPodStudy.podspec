#
#  Be sure to run `pod spec lint en.podspec' to ensure this is a
...
Pod::Spec.new do |spec|
  ...
  # Or just: spec.author    = "杨明鑫"
  # spec.authors            = { "杨明鑫" => "yangmingxin@tuhu.cn" }
  # spec.social_media_url   = "https://twitter.com/杨明鑫"
